...
## Report
<div class='tableauPlaceholder' id='viz1708121665262' style='position: relative'>
    <noscript>
        <a href='#'>
            <img alt=' ' src='https://public.tableau.com/static/images/Sa/SalesDashboard_17081176398890/Dashboard1/1_rss.png' style='border: none' />
        </a>
    </noscript>
    <object class='tableauViz' style='display:none;'>
        ...
        <param name='name' value='SalesDashboard_17081176398890/Dashboard1' />
        <param name='tabs' value='yes' />
        <param name='toolbar' value='yes' />
        <param name='static_image' value='https://public.tableau.com/static/images/Sa/SalesDashboard_17081176398890/Dashboard1/1.png' />
...
<script type='text/javascript'>
    var divElement = document.getElementById('viz1708121665262');
    ...
    if (divElement.offsetWidth > 800) {
        ...
        vizElement.style.minHeight = '1550px';
